        ...
        <div className="py-8">
          <div className="grid grid-cols-2 gap-y-4 md:gap-y-0 sm:grid-cols-4 xl:grid-cols-4 ">
            {footer_itmes?.map((item, index) => {
              return (
                <div key={index}>
                  <h3 className="Footer_footer__title__CRSrF mb-3 md:mb-6">
                    {item?.name}
                  </h3>
                  <ul>
                    {item.child &&
            ...
            <div
              id="register"
              className="grid grid-cols-1 md:gird-cols-[300px_minmax(900px,1fr)_100px] xl:block"
            >
              ...
              <div className="connect__trade mt-5">
                <a
                  href="http://online.gov.vn/Home/WebDetails/5005?AspxAutoDetectCookieSupport=1"
                  target="_blank"
                >
                  <img
        ...
        <div className="Footer_footer__bottom__Ro_Ls">
          <div className="flex justify-start justify-items-start items-center gap-5">
            ...
            <div className="Footer_footer__bottom__content__154Qe">
              ...
              <p>
                Tòa nhà Bitexco Nam Long, 63A Võ Văn Tần, Phường 6, Quận 3,
                Tp.Hồ Chí Minh, Việt Name
              </p>
              <p>
                <i className="fa-solid fa-mobile"></i>
                <a className="hover:text-[#FD841F] transition-all duration-300">
                  : 093.788.0608 -{" "}
                </a>
